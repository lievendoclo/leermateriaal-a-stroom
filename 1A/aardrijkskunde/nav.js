/* ============================================================
   ...
   chapter page of the Aardrijkskunde 1A course.
...
(function () {
  ...
  var CHAPTERS = [
    { file: 'inleiding.html',     title: 'Inleiding — Waarom leer je aardrijkskunde?',     short: 'Inleiding' },
    { file: 'hoofdstuk_01.html',  title: 'H1 — Kaarten lezen',                              short: 'H1' },
    { file: 'hoofdstuk_02.html',  title: 'H2 — Oriënteren en lokaliseren',                  short: 'H2' },
    { file: 'hoofdstuk_03.html',  title: 'H3 — Coördinaten en situeren',                    short: 'H3' },
    { file: 'hoofdstuk_04.html',  title: 'H4 — Fysische landschapselementen',               short: 'H4' },
    { file: 'hoofdstuk_05.html',  title: 'H5 — Menselijke landschapselementen',             short: 'H5' },
    { file: 'hoofdstuk_06.html',  title: 'H6 — Ruimtelijke patronen',                       short: 'H6' },
    { file: 'hoofdstuk_07.html',  title: 'H7 — Landschappen vergelijken',                   short: 'H7' },
    { file: 'hoofdstuk_08.html',  title: 'H8 — Duurzaamheid en de 5 P\'s',                  short: 'H8' },
    { file: 'hoofdstuk_09.html',  title: 'H9 — De krachten van de aarde',                   short: 'H9' },
    { file: 'hoofdstuk_10.html',  title: 'H10 — Weer en extreme weerfenomenen',             short: 'H10' },
    { file: 'hoofdstuk_11.html',  title: 'H11 — Klimaatverandering',                        short: 'H11' },
    { file: 'hoofdstuk_12.html',  title: 'H12 — Mensen veranderen het landschap',           short: 'H12' },
    { file: 'hoofdstuk_13.html',  title: 'H13 — Werken met Geopunt',                        short: 'H13' },
    { file: 'hoofdstuk_14.html',  title: 'H14 — Terreinonderzoek',                          short: 'H14' },
