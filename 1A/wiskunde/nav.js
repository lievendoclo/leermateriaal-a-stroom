/* ============================================================
   ...
   chapter page of the Wiskunde 1A course.
...
(function () {
  ...
  var CHAPTERS = [
    { file: 'inleiding.html',     title: 'Inleiding — Waarom leer je wiskunde?',                     short: 'Inleiding' },
    { file: 'hoofdstuk_01.html',  title: 'H1 — Getallen en getalverzamelingen',                       short: 'H1' },
    { file: 'hoofdstuk_02.html',  title: 'H2 — Bewerkingen met gehele getallen',                      short: 'H2' },
    { file: 'hoofdstuk_03.html',  title: 'H3 — Breuken',                                              short: 'H3' },
    { file: 'hoofdstuk_04.html',  title: 'H4 — Machten en wortels',                                   short: 'H4' },
    { file: 'hoofdstuk_05.html',  title: 'H5 — Priemgetallen, ggd en kgv',                            short: 'H5' },
    { file: 'hoofdstuk_06.html',  title: 'H6 — Procenten, verhoudingen en schaal',                    short: 'H6' },
    { file: 'hoofdstuk_07.html',  title: 'H7 — Hoeken en driehoeken',                                 short: 'H7' },
    { file: 'hoofdstuk_08.html',  title: 'H8 — Vierhoeken en cirkels',                                short: 'H8' },
    { file: 'hoofdstuk_09.html',  title: 'H9 — Transformaties en symmetrie',                          short: 'H9' },
    { file: 'hoofdstuk_10.html',  title: 'H10 — Ruimtelijke figuren',                                 short: 'H10' },
    { file: 'hoofdstuk_11.html',  title: 'H11 — Omtrek en oppervlakte',                               short: 'H11' },
    { file: 'hoofdstuk_12.html',  title: 'H12 — Inhoud en eenheden',                                  short: 'H12' },
    { file: 'hoofdstuk_13.html',  title: 'H13 — Coördinaten en letters',                              short: 'H13' },
    { file: 'hoofdstuk_14.html',  title: 'H14 — Evenredigheid en formules',                           short: 'H14' },
    { file: 'hoofdstuk_15.html',  title: 'H15 — Vergelijkingen van de eerste graad',                  short: 'H15' },
    { file: 'hoofdstuk_16.html',  title: 'H16 — Statistiek',                                          short: 'H16' },
    { file: 'hoofdstuk_17.html',  title: 'H17 — Verzamelingen en wiskundig redeneren',                short: 'H17' },
    { file: 'nawoord.html',       title: 'Nawoord — Op weg naar het examen',                          short: 'Nawoord' }
  ];
