/* ============================================================
   ...
   chapter page of the Techniek 1A course.
...
(function () {
  ...
  var CHAPTERS = [
    { file: 'inleiding.html',    title: 'Inleiding — Over dit vak',                                          short: 'Inleiding' },
    { file: 'hoofdstuk_01.html', title: 'H1 — Materialen en grondstoffen',                                   short: 'H1' },
    { file: 'hoofdstuk_02.html', title: 'H2 — Energiesysteem',                                               short: 'H2' },
    { file: 'hoofdstuk_03.html', title: 'H3 — Informatieverwerkend systeem',                                 short: 'H3' },
    { file: 'hoofdstuk_04.html', title: 'H4 — Constructiesysteem',                                          short: 'H4' },
    { file: 'hoofdstuk_05.html', title: 'H5 — Transportsysteem',                                            short: 'H5' },
    { file: 'hoofdstuk_06.html', title: 'H6 — Biotechnisch systeem',                                        short: 'H6' },
    { file: 'hoofdstuk_07.html', title: 'H7 — Algoritmen',                                                  short: 'H7' },
    { file: 'hoofdstuk_08.html', title: 'H8 — Veiligheid, meetinstrumenten en grootheden',                  short: 'H8' },
    { file: 'hoofdstuk_09.html', title: 'H9 — Technisch proces en STEM',                                    short: 'H9' },
