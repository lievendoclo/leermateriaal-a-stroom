/* ============================================================
   ...
   chapter page of the Samenleving-Economie 1A course.
...
(function () {
  ...
  var CHAPTERS = [
    ...
    { file: 'hoofdstuk_01.html', title: 'H1 — Ik ben wie ik ben',                                 short: 'H1' },
    { file: 'hoofdstuk_02.html', title: 'H2 — Ik leef samen in diversiteit',                      short: 'H2' },
    { file: 'hoofdstuk_03.html', title: 'H3 — Ik reageer correct in een noodsituatie',            short: 'H3' },
    { file: 'hoofdstuk_04.html', title: 'H4 — Ik leef in een democratische rechtsstaat',          short: 'H4' },
    { file: 'hoofdstuk_05.html', title: 'H5 — Ik maak deel uit van een economische kringloop',    short: 'H5' },
    { file: 'hoofdstuk_06.html', title: 'H6 — Ik beheer mijn financiën',                          short: 'H6' },
    { file: 'hoofdstuk_07.html', title: 'H7 — Ik ben digitaal vaardig',                           short: 'H7' },
