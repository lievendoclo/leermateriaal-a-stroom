/* ============================================================
   ...
   chapter page of the Engels 1A course.
...
(function () {
  ...
  var CHAPTERS = [
    { file: 'inleiding.html',    title: 'Inleiding — Waarom leer je Engels?',                short: 'Inleiding' },
    { file: 'hoofdstuk_01.html', title: 'H1 — Hello! Who Are You?',                          short: 'H1' },
    { file: 'hoofdstuk_02.html', title: 'H2 — My Day at School',                             short: 'H2' },
    { file: 'hoofdstuk_03.html', title: 'H3 — Appearance and Health',                        short: 'H3' },
    { file: 'hoofdstuk_04.html', title: 'H4 — Food and Home',                                short: 'H4' },
    { file: 'hoofdstuk_05.html', title: 'H5 — Free Time and Hobbies',                        short: 'H5' },
    { file: 'hoofdstuk_06.html', title: 'H6 — Numbers, Time and Shopping',                   short: 'H6' },
    { file: 'hoofdstuk_07.html', title: 'H7 — Jobs and the World',                           short: 'H7' },
    { file: 'hoofdstuk_08.html', title: 'H8 — Travel and Transport',                         short: 'H8' },
    { file: 'hoofdstuk_09.html', title: 'H9 — Stories from the Past',                        short: 'H9' },
    { file: 'hoofdstuk_10.html', title: 'H10 — The Future and Our World',                    short: 'H10' },
    { file: 'hoofdstuk_11.html', title: 'H11 — Reading and Listening',                       short: 'H11' },
    { file: 'hoofdstuk_12.html', title: 'H12 — Writing, Speaking and Interaction',           short: 'H12' },
