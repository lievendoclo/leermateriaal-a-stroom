/* ============================================================
   ...
   item page of the Voorwerpen die spreken subsection.
...
(function () {
  ...
  var PERSONS = [
    { file: 'leeuwmens.html',       title: 'De Leeuwmens',                        short: 'Leeuwmens' },
    { file: 'lascaux.html',         title: 'De grotschilderingen van Lascaux',    short: 'Lascaux' },
    { file: 'spijkerschrift.html',  title: 'Kleitablet met spijkerschrift',       short: 'Spijkerschrift' },
    { file: 'hammurabi-zuil.html',  title: 'De wetzuil van Hammurabi',            short: 'Wetzuil Hammurabi' },
    { file: 'rosetta.html',         title: 'De Rosetta-steen',                    short: 'Rosetta-steen' },
    { file: 'toetanchamon.html',    title: 'Het masker van Toetanchamon',         short: 'Toetanchamon' },
    { file: 'amfoor.html',          title: 'De Griekse amfoor',                   short: 'Amfoor' },
    { file: 'pompeii.html',         title: 'De gietsels van Pompeii',             short: 'Pompeii' },
  ];
  ...
  nav.setAttribute('aria-label', 'Navigatie voorwerpen die spreken');

  var html = '<div class="personen-nav-inner">';
  html += '<a href="index.html" class="personen-nav-home">← Overzicht voorwerpen</a>';
