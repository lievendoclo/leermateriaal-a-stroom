/* ============================================================
   ...
   page of the Mythen & mysteries subsection.
...
(function () {
  ...
  var PERSONS = [
    { file: 'gilgamesj.html',        title: 'Het epos van Gilgamesj',  short: 'Gilgamesj' },
    { file: 'theseus.html',          title: 'Theseus en de Minotaurus', short: 'Theseus' },
    { file: 'trojaanse-oorlog.html', title: 'De Trojaanse oorlog',      short: 'Trojaanse oorlog' },
    { file: 'romulus-remus.html',    title: 'Romulus en Remus',         short: 'Romulus & Remus' },
    { file: 'icarus.html',           title: 'Icarus en Daedalus',       short: 'Icarus' },
    { file: 'piramides.html',        title: 'Hoe bouwde men de piramides?', short: 'Piramides' },
    { file: 'minoers.html',          title: 'De ondergang van de Minoërs', short: 'Minoërs' },
    { file: 'zeevolken.html',        title: 'Wie waren de Zeevolken?',  short: 'Zeevolken' },
  ];
  ...
  /* ── make header label a link back to mythen index ──────── */
  ...
  nav.setAttribute('aria-label', 'Navigatie mythen & mysteries');

  var html = '<div class="personen-nav-inner">';
  html += '<a href="index.html" class="personen-nav-home">← Overzicht mythen & mysteries</a>';
