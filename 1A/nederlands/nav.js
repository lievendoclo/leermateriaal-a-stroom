/* ============================================================
   ...
   chapter page of the Nederlands 1A course.
...
(function () {
  ...
  var CHAPTERS = [
    { file: 'inleiding.html',     title: 'Inleiding — Waarom leer je Nederlands?',               short: 'Inleiding' },
    { file: 'hoofdstuk_01.html',  title: 'H1 — Wat staat er echt?',                               short: 'H1' },
    { file: 'hoofdstuk_02.html',  title: 'H2 — Welke soort tekst is dit?',                        short: 'H2' },
    { file: 'hoofdstuk_03.html',  title: 'H3 — Kan ik dit vertrouwen?',                           short: 'H3' },
    { file: 'hoofdstuk_04.html',  title: 'H4 — Slim notities nemen',                              short: 'H4' },
    { file: 'hoofdstuk_05.html',  title: 'H5 — Hoe werkt communicatie?',                          short: 'H5' },
    { file: 'hoofdstuk_06.html',  title: 'H6 — Zeggen wat je bedoelt',                            short: 'H6' },
    { file: 'hoofdstuk_07.html',  title: 'H7 — Stap voor stap uitleggen',                         short: 'H7' },
    { file: 'hoofdstuk_08.html',  title: 'H8 — Ik vind dat…',                                     short: 'H8' },
    { file: 'hoofdstuk_09.html',  title: 'H9 — Vertel me alles!',                                 short: 'H9' },
    { file: 'hoofdstuk_10.html',  title: 'H10 — Woorden, woorden, woorden',                       short: 'H10' },
    { file: 'hoofdstuk_11.html',  title: 'H11 — Hoe schrijf ik het goed?',                        short: 'H11' },
    { file: 'hoofdstuk_12.html',  title: 'H12 — De bouwstenen van taal',                          short: 'H12' },
    { file: 'hoofdstuk_13.html',  title: 'H13 — Zinnen bouwen',                                   short: 'H13' },
    { file: 'hoofdstuk_14.html',  title: 'H14 — Welke taal gebruik jij wanneer?',                 short: 'H14' },
    { file: 'hoofdstuk_15.html',  title: 'H15 — Verhalen die bijblijven',                         short: 'H15' },
