/* ============================================================
   ...
   chapter page of the Natuurwetenschappen 1A course.
...
(function () {
  ...
  var CHAPTERS = [
    { file: 'inleiding.html',     title: 'Inleiding — Wat zijn natuurwetenschappen?',          short: 'Inleiding' },
    { file: 'hoofdstuk_01.html',  title: 'H1 — De cel: basisbouwsteen van het leven',           short: 'H1' },
    { file: 'hoofdstuk_02.html',  title: 'H2 — Fotosynthese: planten als energiefabrieken',    short: 'H2' },
    { file: 'hoofdstuk_03.html',  title: 'H3 — Stofomzettingen in het menselijk lichaam',      short: 'H3' },
    { file: 'hoofdstuk_04.html',  title: 'H4 — Voortplanting: van cel tot nieuw leven',        short: 'H4' },
    { file: 'hoofdstuk_05.html',  title: 'H5 — Ecologie: leven in je omgeving',                short: 'H5' },
    { file: 'hoofdstuk_06.html',  title: 'H6 — Materie en het deeltjesmodel',                  short: 'H6' },
    { file: 'hoofdstuk_07.html',  title: 'H7 — Mengsels en zuivere stoffen',                   short: 'H7' },
    { file: 'hoofdstuk_08.html',  title: 'H8 — Massadichtheid',                                short: 'H8' },
    { file: 'hoofdstuk_09.html',  title: 'H9 — Energie en energieomzettingen',                 short: 'H9' },
    { file: 'hoofdstuk_10.html',  title: 'H10 — Krachten en snelheid',                         short: 'H10' },
    { file: 'hoofdstuk_11.html',  title: 'H11 — Wetenschappelijk onderzoek',                   short: 'H11' },
