/* ============================================================
   ...
   chapter page of the Frans 1A course.
...
(function () {
  ...
  var CHAPTERS = [
    { file: 'inleiding.html',     title: 'Inleiding — Bienvenue ! Waarom leer je Frans?',           short: 'Inleiding' },
    { file: 'hoofdstuk_01.html',  title: 'H1 — Se présenter',                                        short: 'H1' },
    { file: 'hoofdstuk_02.html',  title: 'H2 — Ma famille et moi',                                   short: 'H2' },
    { file: 'hoofdstuk_03.html',  title: 'H3 — Les nombres et le temps',                             short: 'H3' },
    { file: 'hoofdstuk_04.html',  title: 'H4 — Au quotidien',                                        short: 'H4' },
    { file: 'hoofdstuk_05.html',  title: 'H5 — Chez moi',                                            short: 'H5' },
    { file: 'hoofdstuk_06.html',  title: 'H6 — À table !',                                           short: 'H6' },
    { file: 'hoofdstuk_07.html',  title: 'H7 — Les loisirs',                                         short: 'H7' },
    { file: 'hoofdstuk_08.html',  title: 'H8 — La mode',                                             short: 'H8' },
    { file: 'hoofdstuk_09.html',  title: 'H9 — La santé',                                            short: 'H9' },
    { file: 'hoofdstuk_10.html',  title: "H10 — À l'école",                                          short: 'H10' },
    { file: 'hoofdstuk_11.html',  title: 'H11 — En ville',                                           short: 'H11' },
    { file: 'hoofdstuk_12.html',  title: 'H12 — Les vacances',                                       short: 'H12' },
    { file: 'hoofdstuk_13.html',  title: 'H13 — Écrire et parler',                                   short: 'H13' },
    { file: 'hoofdstuk_14.html',  title: 'H14 — Lire et comprendre',                                 short: 'H14' },
    { file: 'hoofdstuk_15.html',  title: 'H15 — Révision et bilan',                                  short: 'H15' },
    { file: 'nawoord.html',       title: 'Nawoord — Klaar voor je examen',                           short: 'Nawoord' }
  ];
